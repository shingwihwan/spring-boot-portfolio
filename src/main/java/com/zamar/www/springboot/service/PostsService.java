...
import com.zamar.www.springboot.web.dto.PostsListResponsDto;
...
public class PostsService {
    ...
    public List<PostsListResponsDto> findAllDesc(){
        return postsRepository.findAllDesc().stream().map(PostsListResponsDto::new).collect(Collectors.toList());
    }
